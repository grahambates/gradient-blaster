...
describe("output", () => {
  describe("buildCopperList()", () => {
    ...
    it("formats for amigaOcs in C lang", () => {
      let result = output.buildCopperList(values, {
        varName: "Gradient",
        target: targets.amigaOcs,
        lang: "c",
      });
      expect(result).toBe(`unsigned short Gradient[] = {
	0x2b07,0xfffe,
	0x180,0x000,
	0x3b07,0xfffe,
	0x180,0x111,
    ...
    it("formats for amigaAga in C lang", () => {
      let result = output.buildCopperList(values, {
        varName: "Gradient",
        target: targets.amigaAga,
        lang: "c",
      ...
      // Output too long to include in full
      expect(result).toContain(`unsigned short Gradient[] = {
	0x2b07,0xfffe,
	0x180,0x000,
	0x106,0x200,
	0x180,0x000,
	...
	0x180,0x222,
	0x106,0x000`);
      expect(result).toContain("0xffdf,0xfffe, // PAL fix");
      expect(result).toContain("0xffff,0xfffe // End copper list");
    });
