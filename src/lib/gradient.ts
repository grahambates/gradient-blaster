...
export function adjustColor(color: Color, target: TargetKey) {
...
function closestColor(color: Color, palette: Color[]): Color {
...
function dither(
  ...
  const sameOutput = (a: Color, b: Color) =>
    sameColors(adjustColor(a, target), adjustColor(b, target));
